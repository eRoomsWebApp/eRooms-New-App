                   ...
                   <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                      <div className="lg:col-span-7 space-y-4">
                         <div className="flex items-baseline gap-2 lg:gap-3">
                          ...
                          {/* Other Variants Display */}
                          {((activeRentType === 'Single' ? property.RentSingle : property.RentDouble) as number[]).length > 1 && (
                            <div className="flex flex-wrap gap-3 mt-4">
                              <p className="w-full text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Other Room Variants</p>
